...
session_start();
$sqlQuery = "SELECT n.news_title, m.data, n.news_description, n.date_of_publish FROM add_news n, add_media m where news_type_id=5 and n.media_id=m.id order by news_id desc";
